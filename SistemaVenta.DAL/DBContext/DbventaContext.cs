...
public partial class DbventaContext : DbContext
{
    ...
    public virtual DbSet<Clidocumentos> NumeroDocumentos { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Clidocumentos>(entity =>
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421A11C2ED8E");

            entity.ToTable("NumeroDocumento");

            entity.Property(e => e.IdNumeroDocumento).HasColumnName("idCliDocumento");
            entity.Property(e => e.FechaRegistro)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime")
                .HasColumnName("fechaDeRegistro");
            entity.Property(e => e.UltimoNumero).HasColumnName("ultimoNumeroDeDocumento");
        });
        ...
        modelBuilder.Entity<Producto>(entity =>
        {
            ...
            entity.Property(e => e.Nombre)
                .HasMaxLength(100)
                .IsUnicode(false)
                .HasColumnName("descripcionDeProducto");
            entity.Property(e => e.Precio)
                .HasColumnType("decimal(10, 2)")
                .HasColumnName("precio");
